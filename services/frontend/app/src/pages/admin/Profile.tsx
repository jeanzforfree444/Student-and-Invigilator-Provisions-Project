    ...
    <Box sx={{ maxWidth: 900, mx: "auto", mt: 4, pb: 6 }}>
      ...
      <Panel>
        <Box sx={{ textAlign: "center" }}>
          ...
          <Chip
            label={userData.is_senior_admin ? "Senior Administrator" : "Administrator"}
            color={userData.is_senior_admin ? "success" : "primary"}
            size="medium"
          ...
          <Stack direction="row" spacing={1} justifyContent="center" mt={2}>
            ...
            {showPhotoSave && avatarData && (
              <PillButton variant="outlined" color="primary" onClick={handleSaveProfile} aria-label="Save profile photo">
                Save
              </PillButton>
            )}
            {photoPreview && (
